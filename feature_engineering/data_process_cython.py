...
from featmap_gen_cython import featmap_gen_cython as featmap_gen
...
def main():
    ...
    dataOld = data.reset_index(drop=True)
    data = featmap_gen(dataOld)
    data = pd.concat([dataOld, data], axis=1)
